...
ViewOperacionesVentas viewOperacionesVentas;
   ...
   modelOperacionesVentas.setValues1();
      ...
      //   this.viewOperacionesVentas.jTvendedor.setText(modelIniciarSeccion.getUsername());
               // this.viewOperacionesVentas.jThora.setText(""+this.modelOperacionesVentas.HoraActual());
...
//viewOperacionesVentas.jTtotal.setText(""+this.modelOperacionesVentas.subtotal(););
}
}
