...
public class ModelUsuarios {
  ...
  private String username;                
    ...
    public void guadarRegistro(String username, String password, int status, String level,String nombre) { //('"+username+"', md5('"+password+"'), '"+status+"', '"+level+"');";
        String add = "INSERT INTO usuarios (`usuario`, `password`, `estado`, `tipo`,`nombre`)" + "VALUES ('"+username+"', md5('"+password+"'), '"+status+"', '"+level+"', '"+nombre+"');";
